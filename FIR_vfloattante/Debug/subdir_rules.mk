...
Vectors_intr.obj: ../Vectors_intr.asm $(GEN_OPTS) | $(GEN_HDRS)
	...
	"" -mv6713 --abi=coffabi -g --include_path="/include" --include_path="C:/ti/CCCStudio_v3.1/Support" --include_path="C:/ti/CCCStudio_v3.1/C6000/cgtools/include" --include_path="C:/ti/CCCStudio_v3.1/C6000/csl/include" --include_path="C:/ti/CCCStudio_v3.1/C6000/dsk6713/include" --define=CHIP_6713 --diag_wrap=off --diag_warning=225 --display_error_number --mem_model:data=far --asm_listing --preproc_with_compile --preproc_dependency="Vectors_intr.d" $(GEN_OPTS__FLAG) "$<"
